...
//  auto flow_min_comp = [](const TaskFlow& a, const TaskFlow& b) { return a.flowSize < b.flowSize; };
  auto hop_min_comp = [&](const TaskFlow& a, const TaskFlow& b) { return (g.getHops()[a.src][a.dst] < g.getHops()[b.src][b.dst]) || (g.getHops()[a.src][a.dst] == g.getHops()[b.src][b.dst]) && (a.flowSize > b.flowSize); };
